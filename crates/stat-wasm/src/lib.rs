...
#[no_mangle]
pub unsafe extern "C" fn tukey_hsd_flat(
    dp: *const f64,
    lp: *const f64,
    ng: usize,
    out: *mut f64,
...
#[no_mangle]
pub unsafe extern "C" fn sum_f64_direct(ptr: *const f64, len: usize) -> f64 {
    stat_core::sum(slice_from(ptr, len))
}
#[no_mangle]
pub unsafe extern "C" fn mean_f64_direct(ptr: *const f64, len: usize) -> f64 {
    stat_core::mean(slice_from(ptr, len))
}
#[no_mangle]
pub unsafe extern "C" fn variance_f64_direct(ptr: *const f64, len: usize) -> f64 {
    stat_core::variance(slice_from(ptr, len))
}
#[no_mangle]
pub unsafe extern "C" fn sample_variance_f64_direct(ptr: *const f64, len: usize) -> f64 {
    stat_core::sample_variance(slice_from(ptr, len))
}
#[no_mangle]
pub unsafe extern "C" fn stdev_f64_direct(ptr: *const f64, len: usize) -> f64 {
    stat_core::stdev(slice_from(ptr, len))
}
#[no_mangle]
pub unsafe extern "C" fn sample_stdev_f64_direct(ptr: *const f64, len: usize) -> f64 {
    stat_core::sample_stdev(slice_from(ptr, len))
}
