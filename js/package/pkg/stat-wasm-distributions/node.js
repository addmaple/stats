...
const simdPath = fileURLToPath(new URL("./wasm/stat_wasm_distributions.simd.wasm", import.meta.url));
const basePath = fileURLToPath(new URL("./wasm/stat_wasm_distributions.base.wasm", import.meta.url));
