...
const simdPath = fileURLToPath(new URL("./wasm/stat_wasm_quantiles.simd.wasm", import.meta.url));
const basePath = fileURLToPath(new URL("./wasm/stat_wasm_quantiles.base.wasm", import.meta.url));
