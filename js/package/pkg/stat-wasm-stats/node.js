...
const simdPath = fileURLToPath(new URL("./wasm/stat_wasm_stats.simd.wasm", import.meta.url));
const basePath = fileURLToPath(new URL("./wasm/stat_wasm_stats.base.wasm", import.meta.url));
