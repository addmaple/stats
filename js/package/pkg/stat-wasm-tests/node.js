...
const simdPath = fileURLToPath(new URL("./wasm/stat_wasm_tests.simd.wasm", import.meta.url));
const basePath = fileURLToPath(new URL("./wasm/stat_wasm_tests.base.wasm", import.meta.url));
