...
const simdPath = fileURLToPath(new URL("./wasm/stat_wasm.simd.wasm", import.meta.url));
const basePath = fileURLToPath(new URL("./wasm/stat_wasm.base.wasm", import.meta.url));
